...
public class Focusrecycler extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_focusrecycler);
        ...
        if (currentUser != null) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                if (document.exists()) {
                                    ...
                                    if (message != null) {
                                        ...
                                        Toast.makeText(Focusrecycler.this, "Error parsing data", Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                                    Toast.makeText(Focusrecycler.this, "Document not found", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                Toast.makeText(Focusrecycler.this, "Error fetching data", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
            ...
            Toast.makeText(Focusrecycler.this, "User not authenticated", Toast.LENGTH_SHORT).show();
        }
    }
}