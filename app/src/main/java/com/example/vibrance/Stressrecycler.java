...
public class Stressrecycler extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_stressrecycler);
        ...
        if (currentUser != null) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                if (document.exists()) {
                                    ...
                                    if (message != null) {
                                        ...
                                        Toast.makeText(Stressrecycler.this, "Error parsing data", Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                                    Toast.makeText(Stressrecycler.this, "Document not found", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                Toast.makeText(Stressrecycler.this, "Error fetching data", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
            ...
            Toast.makeText(Stressrecycler.this, "User not authenticated", Toast.LENGTH_SHORT).show();
        }
    }
}